...
export const Bondv2TableItem = (props) => {
    ...
    return (
        ...
        {props.bondv2Member == true &&
            <tr>
                ...
                <td className="d-none d-lg-table-cell">
                    {formatAllUnits(convertFromWei(props.bondedv2LP))}
                ...
                <button type="button" className="btn btn-info waves-effect waves-light m-1 w-75" onClick={()=>toggleUnlock()}>
                    <i className="bx bx-swim font-size-16 align-middle"/> Migrate Bonded LPs
                </button>
...
export default withRouter(withNamespaces()(Bondv2TableItem));